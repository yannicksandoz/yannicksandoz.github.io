...
const FR = {
  ...
  'enter.enter': 'Entrer',
  'enter.guidee': 'Visite guidée',
  'enter.guidee.sub': 'Tout est ouvert · laissez-vous porter',
  'enter.libre': 'Visite libre',
  'enter.libre.sub': 'Explorez · trouvez les jetons ◈',
  'jeton.mot': 'Jeton : atteindre une œuvre inconnue',
  ...
  'enter.reprise': 'Dernière visite : {salle} · {n} œuvre{s} rencontrée{s} sur {total}',
  ...
  'menu.settings.riche': 'Image enrichie (machine puissante)',
  'menu.settings.riche.note': 'Ombres, occlusion ambiante, reflets vivants, anticrénelage ×4 : pour un ordinateur à l\'aise. La galerie s\'en souvient.',
  'menu.settings.riche.reload': 'La galerie se recharge dans la même salle…',
  'riche.propose': 'Votre machine est à l\'aise : activer l\'image enrichie (ombres, occlusion, reflets) ?',
  'riche.activer': 'Activer',
  'riche.plustard': 'Plus tard',
  ...
  'derive.reveal': 'Voir une œuvre inconnue (1 jeton) — il vous en reste {n}',
  'derive.revealNone': 'Toutes les œuvres sont découvertes',
...
const EN = {
  ...
  'enter.enter': 'Enter',
  'enter.guidee': 'Guided visit',
  'enter.guidee.sub': 'Everything open · let yourself drift',
  'enter.libre': 'Free visit',
  'enter.libre.sub': 'Explore · find the ◈ tokens',
  'jeton.mot': 'Token: reach an unknown work',
  ...
  'enter.reprise': 'Last visit: {salle} · {n} of {total} works met',
  ...
  'menu.settings.riche': 'Enriched image (powerful machine)',
  'menu.settings.riche.note': 'Shadows, ambient occlusion, live reflections, ×4 antialiasing: for a computer with headroom. The gallery remembers it.',
  'menu.settings.riche.reload': 'The gallery reloads in the same room…',
  'riche.propose': 'Your machine has headroom: enable the enriched image (shadows, occlusion, reflections)?',
  'riche.activer': 'Enable',
  'riche.plustard': 'Later',
  ...
  'derive.reveal': 'See an undiscovered work (1 token) — {n} left',
  'derive.revealNone': 'Every work has been found',
