...
export class RoomManager {
  ...
  async setCurrent(id, { instant = false, arrival = null, plane = 'sol' } = {}) {
    ...
    this._applyPolicy();
    // LA COQUE AUSSI REÇOIT LES LIGNES. Les œuvres se greffent à leur
    // chargement (Artwork._setMesh) ; murs, sol et plafond naissent ici, et
...
// lumière clé, sa carte, son suivi et l'ombre de contact. Ré-exporté ici
// pour que l'éditeur et les modules existants gardent leurs imports.
export {
